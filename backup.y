...
comando_atribuir:
    TOKEN_IDENTIFICADOR TOKEN_OPERACAO_ATRIBUICAO expressao {
        $$ = criar_no(NO_ATRIBUICAO, strdup(yytext)); 
        $$->filhos[0] = $3; 
    }
;
...
declaracao_variavel:
    tipo lista_identificadores {
        ...
        $$->filhos[0] = $1; // Adiciona o tipo
        $$->filhos[1] = $2; // Adiciona a lista de identificadores
        $$->num_filhos = 2; // Define o número de filhos
    }
;
